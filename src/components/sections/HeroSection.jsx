      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-sm leading-[1.9] text-slate-500 dark:text-slate-400 max-w-[480px] mb-9">
            Passionate frontend developer crafting high-performance, accessible
            web applications with clean code, modern architecture, and
            pixel-perfect interfaces that delight users.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mb-12">
            <button
              ...
              className="px-7 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-mono text-xs tracking-widest uppercase shadow-[0_4px_20px_rgba(37,99,235,0.35)] hover:shadow-[0_8px_28px_rgba(37,99,235,0.5)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              View Projects
            </button>
            ...
            <button
              ...
              className="px-7 py-3 rounded-lg border-[1.5px] border-blue-600 dark:border-blue-500 text-blue-600 dark:text-blue-400 font-mono text-xs tracking-widest uppercase hover:bg-blue-50 dark:hover:bg-blue-500/10 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              Hire Me
            </button>
            ...
            <a
              href="/resume.pdf"
              download
              className="px-7 py-3 rounded-lg border-[1.5px] border-slate-300 dark:border-slate-700 text-slate-600 dark:text-slate-400 font-mono text-xs tracking-widest uppercase hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              ↓ Resume
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-8">
            {HERO_STATS.map(({ num, label }) => (
              <div key={label} className="flex flex-col gap-1">
                <span className="font-display text-[2.2rem] font-extrabold leading-none text-blue-600 dark:text-blue-400">
                  {num}
                </span>
                <span className="font-mono text-[0.6rem] tracking-[2px] uppercase text-slate-400 dark:text-slate-500">
                  {label}
                </span>
              </div>
            ))}
