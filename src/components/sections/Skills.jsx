...
<div className="absolute top-0 left-8 right-8 md:left-16 md:right-16 h-px bg-gradient-to-r from-transparent via-blue-400/25 dark:via-cyan-400/25 to-transparent" />
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 flex flex-col min-h-[80vh]">
        ...
        <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-4 mb-10">
          A curated set of modern technologies and development tools used to
          build scalable, high-performance web applications with clean
          architecture, reusable components, and strong user experience focus.
        </p>
