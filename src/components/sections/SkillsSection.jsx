...
/**
 * SkillsSection — 2-col grid of animated progress-bar cards
 * that fire once on scroll, plus a tech-tag cloud.
 */
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-950/50
                                  ...
                                  flex-shrink-0">
                    <skill.icon className="text-blue-600 dark:text-blue-400 text-base" />
                  </div>
